...
export default function About({ id = 'about' }: AboutProps) {
  ...
  return (
    <section
      id={id}
      className={`min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 px-6 py-20 transition-opacity duration-1000 ${
