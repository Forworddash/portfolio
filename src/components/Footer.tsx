      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="text-center md:text-left">
            <h2 className="text-xl font-bold mb-2">Samuel Baker</h2>
            <p className="text-slate-400 dark:text-slate-500">
              EDI consulting and full-stack development
            </p>
          </div>
          ...
          <div className="flex gap-6">
            ...
            <a
              href="mailto:samuel@samuelbaker.ca"
              className="text-slate-400 dark:text-slate-500 hover:text-white transition-colors"
              aria-label="Email Samuel Baker"
            >
              <svg
                className="w-6 h-6"
                fill="none"
        ...
        <div className="mt-8 pt-8 border-t border-slate-800 dark:border-slate-900 text-center text-slate-400 dark:text-slate-500 text-sm">
          <p>&copy; {currentYear} Samuel Baker. Built with React, TypeScript &amp; Tailwind CSS.</p>
        </div>
      </div>
    </footer>
  );
